...
<html>
<head>
	<title>Training Managment System</title>
	<meta charset="utf-8">
...
<body>
	...
	<div class="container">
	<span><h1>FREE php course from A to Z </h1>
<h2>content</h2>
<h5>
01# PHP Introduction<br>
02# PHP Installation #php<br>
03# PHP Variables<br>
04# PHP Data Types<br>
05# PHP Constants<br>
06# PHP Operators<br>
07# PHP if...else...elseif<br>
08# PHP while Loop<br>
09# PHP do while Loop<br>
10# PHP for Loop<br>
11# PHP foreach Loop<br>
12# PHP Indexed Arrays<br>
13# PHP Associative Arrays<br>
14# PHP Multidimensional Arrays<br>
15# PHP Form Login Part 1<br>
16# PHP Connect to MySQL<br>
17# PHP MySQL Create Table & Insert<br>
18# PHP MySQL Select Data<br>
19# PHP MySQL Update Data<br>
20# PHP MySQL Delete Data<br>
#21 PHP Sessions<br>
22# PHP File Upload<br>
23# PHP Show File Upload<br>
24# PHP Update File Upload<br>
25# PHP Delete File Upload<br>
26# PHP Form Validation<br>
27# PHP Date and Time<br>
28# PHP Cookies<br>
#29 PHP Filter Part 1<br>
#30 PHP Filter Part 2
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<center></center>
        <h4 class="modal-title text-center">Register for the course</h4>
      </div>
...
<div class="form-group col-md-6">
<label for="inputPassword4">Study years</label>
<input type="phone" class="form-control" name="user_phone"  maxlength="2">
</div>
</div>

<div class="form-row">
<div class="form-group col-md-6">
<label for="fathername">univirsity/school name</label>
<input type="text" class="form-control" name="user_father">
</div>
<div class="form-group col-md-6">
<label for="mothername">Specialization</label>
...
<label for="family">About yourself</label>
